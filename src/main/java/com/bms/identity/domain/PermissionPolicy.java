...
public final class PermissionPolicy {
    ...
    public PermissionPolicy() {
        ...
        permissions.put(Role.PCB_LEADER, EnumSet.of(Permission.VIEW_CURRENT_TASK, Permission.VIEW_ALL_TASKS,
                ...
                Permission.DOWNLOAD_STRUCTURE_FILE, Permission.UPLOAD_MUTUAL_CHECK_FILE, Permission.DOWNLOAD_MUTUAL_CHECK_FILE, Permission.MANAGE_USER, Permission.VIEW_USER,
        ...
        permissions.put(Role.HARDWARE_EXPERT, EnumSet.of(Permission.VIEW_CURRENT_TASK, Permission.VIEW_ALL_TASKS,
                ...
                Permission.DOWNLOAD_PROCESS_FILE, Permission.DOWNLOAD_STRUCTURE_FILE, Permission.UPLOAD_MUTUAL_CHECK_FILE, Permission.DOWNLOAD_MUTUAL_CHECK_FILE));
